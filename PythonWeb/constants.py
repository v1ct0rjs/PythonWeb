...
proyectos = [
    ...
    {"title": "LoRaIM", "subtitle": "LoRaIM (LoRa Instant Messenger) plataforma mensageria que utiliza LoRa.",
    ...
    {"title": "Grafana Octopus", "subtitle": "Stack de Monitoreo con Grafana, InfluxDB 2 y Telegraf.",
     "url": "https://github.com/v1ct0rjs/grafana_octopus", "icon": "/grafana.svg"},
    {"title": "Jenkins Deployment", "subtitle": "Automatización CD/CI hacia DockerHub utilizando Jenkins.",
     "url": "https://github.com/v1ct0rjs/jenkins_deployment", "icon": "/jenkins.svg"},
    {"title": "Integración SonarQube",
     "subtitle": "Instancia pública de SonarQube utilizando un tunel Ngrok.",
     "url": "https://github.com/v1ct0rjs/jenkins_deployment/tree/main/SonarQube", "icon": "/sonarqube.svg"},
    {"title": "OC Db autonoma", "subtitle": "Base de datos autónoma en Oracle Cloud Infrastructure.",
     "url": "https://github.com/v1ct0rjs/oci-autonomousdb", "icon": "/database.svg"},
